...
public class ChefPostgresDAO implements ChefDAO
{
	@Override
	public Utente searchChef(String emailOrUsername, String password) throws SQLException 
	{
		// Connection dataBase 
...
//		if (seemsLikeEmail) {
	...
	@Override
	public boolean insertChef(Utente Utente) throws SQLException 
	{
		Connection dataBase = DriverManager.getConnection("jdbc:postgresql://localhost:5432/FoodLab2025", "postgres", "a");
