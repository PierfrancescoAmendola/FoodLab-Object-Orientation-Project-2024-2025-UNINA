...
public class AvvisoDAO {
     ...
     */
    public static boolean insertAvviso(Avviso avviso) throws SQLException {
     ...
     */
    public static ArrayList<Avviso> getAvvisiByUtente(String idUtente) throws SQLException {
     ...
     */
    public static ArrayList<Avviso> getAvvisiNonLettiByUtente(String idUtente) throws SQLException {
        ArrayList<Avviso> avvisi = new ArrayList<>();
        Connection dataBase = DriverManager.getConnection("jdbc:postgresql://localhost:5432/FoodLab2025", "postgres", "a");
     ...
     */
    public static boolean segnaAvvisoComeLetto(int idAvviso) throws SQLException {
        Connection dataBase = DriverManager.getConnection("jdbc:postgresql://localhost:5432/FoodLab2025", "postgres", "a");
     ...
     * Elimina un avviso
     */
    public static boolean deleteAvviso(int idAvviso) throws SQLException {
        Connection dataBase = DriverManager.getConnection("jdbc:postgresql://localhost:5432/FoodLab2025", "postgres", "a");
     ...
     */
    public static int contaAvvisiNonLetti(String idUtente) throws SQLException {
        Connection dataBase = DriverManager.getConnection("jdbc:postgresql://localhost:5432/FoodLab2025", "postgres", "a");
     ...
     */
    public static ArrayList<Avviso> getAvvisiByCorso(String idCorso) throws SQLException {
        ArrayList<Avviso> avvisi = new ArrayList<>();
        Connection dataBase = DriverManager.getConnection("jdbc:postgresql://localhost:5432/FoodLab2025", "postgres", "a");
